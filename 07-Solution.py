...
class CumulativeSize:
    ...
    def suma_menores_a_100k(self):
        total = sum([tamaño if tamaño <= 100_000 else 0 for _,
                    tamaño in self.diccionario_paths.items()])
...
assert respuestas_cortas.justo_encima_de() == 24_933_642, "Creía que era " + \
    str(respuestas_cortas.justo_encima_de())


RespuestaA, RespuestaB = respuestas_largas.suma_menores_a_100k(
), respuestas_largas.justo_encima_de()
