...
with open(archivoSolucion, 'a') as file_object:
    ...
    file_object.write("corto=[]\n\n")
    file_object.write("RespuestaCortaA, RespuestaA, RespuestaCortaB, RespuestaB = 'N/A', 'N/A', 'N/A', 'N/A'\n\n\n")
    file_object.write('print("\tLa respuesta del Ejemplo A es " + str(RespuestaCortaA))\n')
    file_object.write('print("\tLa respuesta A es " + str(RespuestaA))\n')
    file_object.write('print("\tLa respuesta del Ejemplo B es " + str(RespuestaCortaB))\n')
    file_object.write('print("\tLa respuesta B es " + str(RespuestaB))\n')

# with open(inputcortoFile) as file_object:lines = file_object.readlines()
# inputcorto=[]
# for line in lines: inputcorto.append(line.rstrip())
